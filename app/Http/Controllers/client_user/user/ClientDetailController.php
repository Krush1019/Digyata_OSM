...
class ClientDetailController extends Controller
{
    ...
    $services = DB::table('tbl_user_ser_list')
                ...
                ->join('tbl_service_catalogs as tsc', 'tbl_user_ser_list.ser_cat_id', '=', 'tsc.id')
                ->join('tbl_client_manage as tcm', 'tbl_user_ser_list.ser_cat_id', '=', 'tcm.id')
                ->first();

    $items = DB::table('tbl_user_ser_item_price')
                ->where('ser_id', '=', $decrypted)
                ->get();
