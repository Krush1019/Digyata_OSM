                                    ...
                                    <div class="row">
                                          <div class="col-md-3 col-sm-6 add_bottom_25">
                                                ...
                                                <input type="range" min="0" max="5" step="1" @if ($checkReview)
                                                      value="{{$checkReview->Res_R1}}" @else value="0" @endif
                                          ...
                                          <div class="col-md-3 col-sm-6  add_bottom_25">
                                                ...
                                                <input type="range" min="0" max="5" step="1" @if ($checkReview)
                                                      value="{{$checkReview->Ser_R2}}" @else value="0" @endif
                                          ...
                                          <div class="col-md-3 col-sm-6  add_bottom_25">
                                                ...
                                                <input type="range" min="0" max="5" step="1" @if ($checkReview)
                                                      value="{{$checkReview->Com_R3}}" @else value="0" @endif
                                          ...
                                          <div class="col-md-3 col-sm-6  add_bottom_25">
                                                ...
                                                <input type="range" min="0" max="5" step="1" @if ($checkReview)
                                                      value="{{$checkReview->Price_R4}}" @else value="0" @endif
