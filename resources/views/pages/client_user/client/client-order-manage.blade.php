...
<div class="box_general">
	...
	<div class="list_general pb-1">
		...
		<p><a href="#viewordermodal" data-toggle="modal" class="btn_1 gray"><i class="fa fa-fw fa-eye"></i> View
				Order</a></p>
		<ul class="buttons">
			<li><a href="#0" class="btn_1 gray"><i class="fa fa-fw fa-envelope mr-1"></i>Send Email</a></li>
			<li><a href="#viewordermodal" data-toggle="modal" class="btn_1 gray"><i class="fa fa-fw fa-eye"></i>
					View Order</a></li>
		</ul>
		</li> --}}
				...
				<div class="row">
					...
					<div class="box_general m-4 w-100 pb-4 viewservicespan">
						...
						<div class="mt-5">
							...
							<div class="col-sm-12 font-large-17 font-weight-bold pl-0 provider_name">Car
								Washer PVT LTD</div>
						</div>
						...
						<div class="row">
							<div class="col-md-5 mt-5">
								...
								<div class="col-sm-12 font-large-17 font-weight-bold pl-0  city">
									Mahesana - Gujarat</div>
							</div>
							<div class="col-md-7 mt-5">
								<div class="col-sm-12 small pl-0 mb-5">Address :</div>
								<div class="col-sm-12 pl-0  font-weight-bold address">20, Madhuvan
							...
							<div class="col-md-5">
								...
								<div class="mt-5">
									...
									<div
										...
										<a href="mailto:parth@gmail.com">parth@gmail.com</a></div>
								</div>
							</div>
						</div>
