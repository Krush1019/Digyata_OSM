...
<form method="POST" id="addServiceListForm" enctype="multipart/form-data">
    	...
    	<div class="row">
					...
					<select id="SL_ser_name" name="SL_ser_name" class="form-control styled-select">
						...
						@else
							...
							@foreach ($serviceData as $row)
								<option value="{{$row->serviceName}}" data-category="{{$row->serviceCategory}}" data-id="{{$row->id}}">{{$row->serviceName}}</option>
							@endforeach
						@endif		
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="SL_ser_category" id="SL_ser_category" placeholder="Category" disabled>
				</div>
			</div>
    	</div>
    	<!-- /row-->
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="SL_Ser_shopname" id="SL_Ser_shopname" placeholder="Shop Name / Provide Name">
				</div>
			</div>
			...
			<div class="col-md-6">
				...
				<input type="text" class="form-control" name="SL_Ser_experience" id="SL_Ser_experience" placeholder="2 Months / 2 Years">
				</div>
			</div>
    	</div>
    	<!-- /row-->
		...
		<div class="row">
			<div class="col-md-5">
        		<div class="form-group">
					...
					<div class="custom-file">
						<input type="file" class="custom-file-input" id="SL_ser_idproof" name="SL_ser_idproof">
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="SL_Ser_aadharNo"  id="SL_Ser_aadharNo" placeholder="Aadhar No.">
				</div>
			</div>
    	...
    	<div class="row">
      		<div class="col-md-6">
        		<div class="form-group">
					...
					<input type="text" class="form-control" placeholder="ex. 250, Fifth Avenue..." name="SL_ser_address" id="SL_ser_address">
        		</div>
      		</div>
    	...
    	<div class="row">
        		...
        		<div class=" form-group">
					...
					<div class="row">
						<span class="mr-2 col-md-1 col-sm-12">
						  ...
						  <span class="mr-2 col-md-3 col-sm-12">
			...
			<div id="add-day-div" class="col-md-12" hidden="hidden">
        		<div class="row add-day-data">
					...
					<div class="col-md-5">
						<div class="form-group">
							<select class="form-control styled-select styled-select-value optime" name="add_day_data_optime"></select>
						</div>
					</div>
          			<div class="col-md-5">
            			<div class="form-group">
              				<select class="form-control styled-select styled-select-value cltime" name="add_day_data_cltime"></select>
            			</div>
          			</div>
				</div>
			</div>
              				...
              				<div class="row ">
                				...
                				<div class="col-md-3">
                  					<div class="form-group input-group">
										...
										<input type="text" name="pli_price" class="form-control" placeholder="Price" aria-describedby="price_icon">
                  					</div>
                				</div>
                				<div class="col-md-1 ">
	...
	<!-- /box_general-->
	<p><input type="button" class="btn_1 medium" id="addServiceListbtn" value="Save"></p>
</form>
