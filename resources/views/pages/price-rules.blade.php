								...
								<div class="ag-grid-btns d-flex justify-content-between flex-wrap mb-1">
									<div class="dropdown sort-dropdown mb-1 mb-sm-0">
										...
										<button type="button" data-toggle="modal" data-target="#PriceRulesFormDiv"
										        class="btn btn-icon btn-icon rounded-1 ml-1 btn-outline-primary font-medium-1 btn-flat-primary waves-effect waves-light ">
				...
				<div class="modal-content">
					...
					<form action="javaScript:void(0)" id="PriceRulesForm" method="post" novalidate>
						<div class="modal-body">
							<div id="hidemodel" class="form-group">
								<div class="controls">
									...
									<input type="text" name="npr_sername" id="pr_sername"
							...
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-12">
									<div class="form-group">
										<div class="controls">
											<label for="PriceRules-minPrice">Min Price: </label>
											<input type="text" name="npr_minprice" id="pr_minprice"
								...
								<div class="col-lg-6 col-md-6 col-sm-12">
									<div class="form-group">
										<div class="controls">
											<label for="PriceRules-maxPrice">Max Price: </label>
											<input type="text" name="npr_maxprice" id="pr_maxprice"
							...
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-12">
									<div class="form-group">
										<div class="controls">
											<label for="PriceRules-visitBrokrage">Visit Charge Brokrage(%): </label>
								...
								<div class="col-lg-6 col-md-6 col-sm-12">
									<div class="form-group">
										<div class="controls">
											<label for="PriceRules-serviceBrokrage">Service Charge Brokrage(%): </label>
						...
						<div class="modal-footer">
							<button type="submit" id="sbt_btn"
							        class="btn btn-outline-success waves-effect waves-light" autofocus
							        data-action="insert">Update Price Rule
							</button>
