...
<html>
<head>
	<title>Welcome to Digyata!</title>
	<meta charset="utf-8" />
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%"><!-- Image Top-->
								...
								<tr>
									...
									<table border="0" cellpadding="0" cellspacing="0" width="100%"><!-- Copy Title -->
											...
											<tr>
												<td align="center" class="padding" style="font-size: 30px; font-weight: bold; font-family: 'proxima_nova_bold', Proxima Nova, Helvetica, Arial, sans-serif; color: #333333; padding-top: 30px;">Welcome to Digyata, {{$clnt['name']}}</td>
											</tr>
											<!-- /Copy Title --><!-- Copy Body -->
											<tr>
												<td align="center" class="padding" style="padding: 20px 0 0 0; font-size: 16px; line-height: 25px; font-family: 'proxima_nova_reg', Proxima Nova, Helvetica, Arial, sans-serif; color: #999999;">You are one step ahead to provide your service on digyata. we believe you are our valuable client and we provide all our support to you to list your First service on Digyata. Happy to see you onboarding <br> Here are some steps to list your Service</td>
											</tr>
											<!-- /Copy Body -->
